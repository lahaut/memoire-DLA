...
\begin{Def}
 Pour $z \in \mathbb{Z}^d \setminus \{ 0 \}$ on note $\Sigma (z) = \partial \mathbb{B} (0, \| z \| )$. Remarquons que $z \in \Sigma (z)$.
\end{Def}
...
\begin{Lemme}
 ...
 \begin{equation*}
  P(N_z (X, \Lambda, \infty ) = 0, N_z (X, \Lambda ', R) = 0) \leqslant \exp \left( - \kappa \frac{\lambda R}{\| z \| ^{d-1} } \right)
 \end{equation*}
